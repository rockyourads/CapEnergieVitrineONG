export default {
  ...
  values: {
    title: 'Nos valeurs',
    trust: 'Construire sur la confiance',
    trustDesc:
      'Des partenariats durables avec les ONG, basés sur la transparence et la fiabilité.',
    team: 'Une équipe pleinement investie',
    teamDesc:
      "Des experts passionnés qui s'engagent pleinement dans chaque projet humanitaire.",
    purpose: 'Agir avec sens',
    purposeDesc:
  ...
  featured: {
    ...
    subtitle:
      'Découvrez nos installations photovoltaïques réalisées pour des ONG à travers le monde.',
  ...
  projectsPage: {
    title: 'Nos projets',
    subtitle:
      'Découvrez nos installations photovoltaïques réalisées pour des ONG et organisations dans le monde entier.',
  ...
  aboutPage: {
    title: 'À propos de Cap Énergie',
    subtitle:
      "Depuis 2007, Cap Énergie accompagne les ONG et organisations humanitaires dans leurs projets d'électrification solaire.",
    historyTitle: 'Notre histoire',
    history1:
      'Fondée en 2007 à Montpellier, {company} est un distributeur photovoltaïque et concepteur de solutions off-grid.',
    history2:
      "Avec plus de 25 ans d'expérience à l'export, notre équipe s'est spécialisée dans les marchés africains et asiatiques, où les besoins en électrification sont les plus critiques.",
    history3:
      'Nous concevons des systèmes solaires autonomes adaptés aux conditions les plus exigeantes : centres médicaux isolés, villages sans réseau électrique, infrastructures humanitaires en zones de crise.',
    history4:
      'Notre mission : fournir une énergie fiable et durable aux populations qui en ont le plus besoin, en partenariat avec les grandes ONG internationales.',
    foundersTitle: 'Les fondateurs',
    zonesTitle: "Zones d'intervention",
    africa: 'Afrique',
    africaCountries: 'Burkina Faso, Tchad, Niger, Kenya, Madagascar, Djibouti, Sierra Leone, Sénégal...',
    asia: 'Asie',
    asiaCountries: 'Philippines, Laos...',
    caribbean: 'Caraïbes',
    caribbeanCountries: 'Dominique, Guyane...',
    domtom: 'DOM-TOM',
    domtomCountries: 'Guyane française...',
    ctaTitle: 'Travaillons ensemble',
    ctaSubtitle:
      "Vous êtes une ONG avec un projet d'électrification ? Parlons-en.",
    ctaButton: 'Demander un devis',
  },
  quotePage: {
    title: 'Demander un devis',
    subtitle:
      "Décrivez votre projet d'électrification solaire et notre équipe vous recontactera dans les plus brefs délais.",
    successTitle: 'Demande envoyée !',
    successMessage:
      'Merci pour votre demande. Notre équipe vous recontactera dans les plus brefs délais.',
    organization: "Nom de l'organisation / ONG",
    organizationPlaceholder: 'Ex: Croix Rouge, MSF...',
    ...
    countryPlaceholder: 'Ex: Burkina Faso, Philippines...',
    description: 'Description du besoin',
    descriptionPlaceholder:
      "Type d'installation, puissance estimée, nombre de sites...",
    message: 'Message libre',
    messagePlaceholder: 'Informations complémentaires...',
    submitting: 'Envoi en cours...',
    submit: 'Envoyer la demande de devis',
    disclaimer:
      "En soumettant ce formulaire, vous acceptez d'être recontacté par Cap Énergie concernant votre demande.",
    contactDirect: 'Vous pouvez aussi nous contacter directement au',
    hq: 'Siège : Montpellier, France',
  },
  footer: {
    description:
