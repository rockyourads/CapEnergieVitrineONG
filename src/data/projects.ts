...
export const projects: Project[] = [
  {
    ...
    galleryFolder: 'local-croix-rouge-philipines',
  },
  {
  ...
  },
  {
    ...
    description: "Système de pompage solaire au Kenya en partenariat avec Électriciens Sans Frontières. Accès à l'eau potable pour les communautés locales.",
    image: '/images/projects/pompage-kenya.jpg',
    galleryFolder: 'pompage-kenya',
  },
  {
    ...
    clientType: 'ONG',
    category: 'Pompage solaire',
    description: "Installation de pompage solaire à Madagascar avec Électriciens Sans Frontières. Solution durable d'accès à l'eau pour les populations rurales.",
    image: '/images/projects/pompage-madagascar.jpg',
    galleryFolder: 'pompage-madagascar',
  },
  {
    id: 'pv-djibouti',
  ...
  {
    id: 'ferme-solaire-philipines',
    title: 'Ferme solaire - Philippines',
    country: 'Philippines',
    countryCode: 'PH',
    client: 'Électriciens Sans Frontières',
    clientType: 'ONG',
    category: 'Site Isolé / Off Grid',
    description: "Construction d'une ferme solaire aux Philippines avec Électriciens Sans Frontières. Électrification durable pour les communautés rurales isolées.",
    image: '/images/esf/ferme-solaire-philipines/1241.jpg',
    galleryFolder: 'ferme-solaire-philipines',
  },
  {
    id: 'maroc-lampe-solaire',
    title: 'Lampes solaires - Maroc',
    country: 'Maroc',
    countryCode: 'MA',
    client: 'Électriciens Sans Frontières',
    clientType: 'ONG',
    category: 'Site Isolé / Off Grid',
    description: "Distribution de lampes solaires au Maroc avec Électriciens Sans Frontières. Accès à l'éclairage pour les populations en zones non raccordées.",
    image: '/images/esf/maroc-lampe-solaire-2024/dsc_1158-scaled.jpg',
    galleryFolder: 'maroc-lampe-solaire-2024',
  },
  {
    id: 'pompage-kenya-2021',
    title: 'Pompage solaire - Kenya 2021',
    country: 'Kenya',
    countryCode: 'KE',
    client: 'Électriciens Sans Frontières',
    clientType: 'ONG',
    category: 'Pompage solaire',
    description: "Deuxième mission de pompage solaire au Kenya avec Électriciens Sans Frontières. Extension du réseau d'accès à l'eau potable.",
    image: '/images/esf/pompage-kenya-2021/1.jpg',
    galleryFolder: 'pompage-kenya-2021',
  },
  {
    id: 'pv-guebakui',
    title: 'Installation PV - Guébakui',
    country: 'Togo',
    countryCode: 'TG',
    client: 'Électriciens Sans Frontières',
    clientType: 'ONG',
    category: 'Site Isolé / Off Grid',
    description: "Installation photovoltaïque à Guébakui au Togo avec Électriciens Sans Frontières. Système solaire pour les infrastructures communautaires.",
    image: '/images/esf/pv-guebakui/p1040087.jpg',
    galleryFolder: 'pv-guebakui',
  },
  {
    id: 'senegal-esf',
