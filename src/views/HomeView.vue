      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            ...
            :key="project.id"
            class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group reveal"
            :class="[projectsVisible && 'is-visible', `stagger-${index + 1}`]"
          >
            <div class="h-52 bg-gradient-to-br from-primary/10 to-accent/5 flex items-center justify-center overflow-hidden">
              <svg class="w-16 h-16 text-primary/20 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
